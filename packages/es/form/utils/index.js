...
export function isHasInputTarget(evt) {
  if (evt !== null && evt !== void 0 && evt.target) {
    var _evt$stopPropagation;
    if (_typeof(evt.target) === 'object' && ('value' in evt.target || 'checked' in evt.target)) return true;
    (_evt$stopPropagation = evt.stopPropagation) === null || _evt$stopPropagation === void 0 ? void 0 : _evt$stopPropagation.call(evt);
  }
  return false;
}
export function getValuesByEvt(args) {
  return args.map(function (evt) {
    if (evt !== null && evt !== void 0 && evt.target) {
